...
sorted_coords_1d = np.array([-0.3,  0.,  0.1,  1.,  1.5])

coords_2d = np.array([[1.0, 0.1, 1.5, -0.3, 0.0], [1.5, 0.2, 1.3, -0.1, 0.7]]).transpose()
sorted_coords_2d = np.array([[-0.3, -0.1], [0., 0.7], [0.1, 0.2], [1., 1.5], [1.5, 1.3]])
